...
//		System.out.println("LstSoldados.size = "+getLstSoldados().size());
//		System.out.println("get(0) = "+getLstSoldados().get(0));
//		System.out.println("Exercito = "+getLstSoldados().get(0).getExercito());
//		System.out.println("Color = "+getLstSoldados().get(0).getExercito().getCor());
	...
	public void atualizaLblnumsoldados() {
 	...
 	public Territorio(String nome, int numSoldados, String dono) {
		this.nome = nome;
		this.dono = dono;
		for (int i=0;i<numSoldados;i++)
		{
			Soldado a = new Soldado(dono);
			addSoldado(a);
		}
	}
