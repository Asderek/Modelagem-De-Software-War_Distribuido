	...
	private void carregaBtnProximoJogada() {
		...
		btnProxJogada.addMouseListener(new MouseListener() {
			...
			public void mouseExited(MouseEvent e) {
				// TODO Auto-generated method stub
				try {
					ControllerTabuleiro.getInstance().setMensagem("ClientColor = "+Client.getInstance().getColor());
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
			...
			public void mouseEntered(MouseEvent e) {
				// TODO Auto-generated method stub
				ControllerTabuleiro.getInstance().setMensagem("JogadorDaVez = "+ControllerTabuleiro.getInstance().getJogadorDaVez().getNome());
			}
